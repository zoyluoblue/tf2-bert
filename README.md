...
# INSTALLATION  
git clone https://github.com/zoyluoblue/tf2-bert.git  
 ...
 * Just follow the demos and tasks. Before running, remember ro download NER and comment data from
 [https://github.com/zoyluoblue/tf2-bert/releases/download/1.0.0/BERT_COMMENT.zip](https://github.com/zoyluoblue/tf2-bert/releases/download/1.0.0/BERT_COMMENT.zip)
 and [https://github.com/zoyluoblue/tf2-bert/releases/download/1.0.0/BERT_NER.zip](https://github.com/zoyluoblue/tf2-bert/releases/download/1.0.0/BERT_NER.zip),
